 ...
 * Example usage PUT and GET:
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#e6c07b">HttpResult&lt;Profile&gt;</span> httpResult = httpClient.<span style="color:#61afef">getAndConvertToObject</span><span style="color:#e8ba36">(</span><span style="color:#98c379">&quot;http://<ipaddr>:<port>/profile?uuid=e8420a7e-964d-4ac7-838e-37b08b6b25dc&quot;</span>, <span style="color:#e6c07b">Profile</span>.<span style="color:#c678dd">class</span><span style="color:#e8ba36">)</span>;
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#e6c07b">HttpResult</span>&lt;<span style="color:#e6c07b">String</span>&gt; httpResult = httpClient.<span style="color:#61afef">put</span><span style="color:#e8ba36">(</span><span style="color:#98c379">&quot;http://<ipaddr>:<port>/profile&quot;</span>, profile<span style="color:#e8ba36">)</span>;
